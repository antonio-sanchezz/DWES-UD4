...
<body>
    ...
    if ($stmt = mysqli_prepare($mysqli, $sql)) {
        ...
        while(mysqli_stmt_fetch($stmt)) {
            print "El vuelo con origen $origen y destino $destino tiene fecha prevista $fecha y es operado por la compañía $companya con el modelo de avion $modeloAvion";
        }
